...
class PlivoCallController: UIViewController, JCDialPadDelegate {
...
//    var incCall: PlivoIncoming?
    ...
    override func viewDidLoad() {
        ...
        CallKitInstance.sharedInstance.callKitProvider?.setDelegate(self as! CXProviderDelegate, queue: DispatchQueue.main)
        CallKitInstance.sharedInstance.callObserver?.setDelegate(self as! CXCallObserverDelegate, queue: DispatchQueue.main)
